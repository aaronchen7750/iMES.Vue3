<template>
  <div class="bg">
      ...
      <div class="login">
        <div class="login-contianer">
          <div class="login-form">
            ...
            <div class="app-link">
              <!-- <a href="https://wechat.625sc.com:8891/iMES.exe" style="text-decoration: none">桌面客户端</a> -->
              <a style="text-decoration: none">桌面客户端</a>
              <a>
                <i class="el-icon-chat-dot-round"></i> 小程序
                <!-- <img src="https://wechat.625sc.com:8891/WXApp.jpg" /> -->
              </a>
              <a>
                <i class="el-icon-mobile-phone"></i>Android
                <!-- <img src="https://wechat.625sc.com:8891/Android.png" /> -->
              </a>
              <a>
                <i class="el-icon-document"></i> H5
                <!-- <img src="https://wechat.625sc.com:8891/H5.png" /> -->
              </a>
            </div>
          </div>
        </div>
    ...
    <div class="login-footer">
      <a style="text-decoration: none" href="https://beian.miit.gov.cn/" target="_blank">Copyright © 2023 iMES信息科技有限公司
        版权所有 冀ICP备2021023799号-1</a>
      <a>作者QQ/微信：49872850/17754797750</a>
    </div>
  </div>
</template>
<script>
