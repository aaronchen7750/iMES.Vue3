    ...
    <div class="mes-aside" :style="{ width: menuWidth + 'px' }">
      ...
      <div class="mes-menu">
        <el-scrollbar style="height: 100%">
          ...
          <MesMenu :currentMenuId="currentMenuId" :on-select="onSelect" :enable="true" :open-select="false"
            :isCollapse="isCollapse" :list="menuOptions"></MesMenu>
        </el-scrollbar>
      </div>
    </div>
    <div class="mes-container" :style="{ left: menuWidth - 1 + 'px' }">
      <div class="mes-header">
        <div class="project-name">iMES工厂管家</div>
        ...
        <div v-show="contextMenuVisible">
          <ul :style="{ left: menuLeft + 'px', top: menuTop + 'px' }" class="contextMenu">
            ...
            <li v-show="visibleItem.left">
              <el-button type="text" @click="closeTabs('left')"><i class="el-icon-back"></i>关闭左边</el-button>
            </li>
            ...
            <li v-show="visibleItem.other">
              <el-button type="text" @click="closeTabs('other')"><i class="el-icon-right"></i>关闭其他
              </el-button>
            </li>
          </ul>
        </div>
    ...
    <el-drawer title="选择主题" v-model="drawer_model" direction="rtl" destroy-on-close>
      <div class="theme-selector">
        <div @click="changeTheme(item.name)" class="item" v-for="(item, index) in theme_color" :key="index"
          ...
          <div v-show="item.leftColor" :style="{ background: item.leftColor }" style="height: 100%; width: 100px"
            class="t-left"></div>
